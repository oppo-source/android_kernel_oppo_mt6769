...
{
	printk("a0013 lcm_shudown_power\n");
...
static void lcm_init(void)
{
	...
	pr_err("p_3a0013_lcm_mode = vdo mode :%d\n", lcm_dsi_mode);
}
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	if (1 == last_powerflag) {
			...
			pr_err("[ HW  backlight a0013]level_1 = %d para_list[0] = %x, \
			...
			pr_err("[ HW  backlight a0013]level = %d para_list[0] = %x, \
